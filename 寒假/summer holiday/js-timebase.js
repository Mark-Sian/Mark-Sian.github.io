...
$.fn.timebase = function(options){
  ...
  setting = $.extend({
    ...
    boolean_transition         : true,                     //value: 内容面板是否拉伸     elements: bool
    boolean_opacity            : true,                     //value: 透明度是否变化      elements: bool
    boolean_keyboard           : true,                     //value: 键盘控制           elements: bool
    boolean_scroll             : true,                      //value: 鼠标滚轮控制        elements: bool
  },options);
